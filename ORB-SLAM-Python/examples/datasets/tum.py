...
class TUMDataset:
    ...
    def __getitem__(self, idx):
        ...
        rgb = cv2.imread(f"{self.data_source}/rgb/{rgb_id:.6f}.png", cv2.IMREAD_UNCHANGED)
        depth = cv2.imread(f"{self.data_source}/depth/{depth_id:.6f}.png", cv2.IMREAD_UNCHANGED)
